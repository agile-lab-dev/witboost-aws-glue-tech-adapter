...
- build the fat jar and launch the application with a JVM with the agent attached:
  ...
  java -javaagent:path/to/opentelemetry-javaagent.jar -jar common/target/glue-tech-adapter.jar
  ```
...
OTEL_SERVICE_NAME=glue-tech-adapter \
