...
This project implements a simple Tech Adapter for Amazon Glue Jobs.
You can find more details about the High-Level Design of this Tech Adapter [here](docs/HLD.md).
